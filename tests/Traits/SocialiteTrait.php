...
{
    public function makeSocialiteServiceStub(string $method, $return)
    {
     ...
     */
    public function makeSocialiteServiceStubWithMultipleResponses(string $method, array $responses)
    {
        $socialiteServiceStub = $this->createStub(SocialiteService::class);
